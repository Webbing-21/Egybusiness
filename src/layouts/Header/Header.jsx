...
function App() {
  ...
  const searchByCategory = (event) => {
    ...
    searchInput && navigate(`/products?category=${searchInput}`)
  } 
    ...
    <>
      <header className="navbar d-flex align-items-center">
        <div className="d-flex align-items-center gap section-logo">
          ...
          <div
            className={
              searchMenu ? "searchMenuStyle active " : "searchMenuStyle hide"
            }
          >
            <Form onSubmit={searchByCategory}>
              <InputGroup>
                ...
                <Form.Control
                  ...
                  value={searchInput}
                />
                <InputGroup.Text id="btnGroupAddon" style={{cursor: 'pointer'}} onClick={searchByCategory}>
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
        ...
        <div className="d-flex gap-2">
          ...
          <nav
            className={`links d-lg-none gap-1 mobile-menu ${
              menuShow ? " active " : ""
            }`}
          >
            <LinksNav
          ...
          <nav className={`links d-none d-lg-flex gap-1`}>
            <LinksNav
              userData={userData || null}
              menuShow={menuShow}
              setMenuShow={setMenuShow}
